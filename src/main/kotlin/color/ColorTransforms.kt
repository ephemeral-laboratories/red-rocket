...
object ColorTransforms {
    ...
    fun cieXyzToLinearRgb(components: ImmutableDoubleArray): ImmutableDoubleArray = CIE_XYZ_TO_LINEAR_RGB.times(components)

    fun linearRgbToCieXyz(components: ImmutableDoubleArray): ImmutableDoubleArray = LINEAR_RGB_TO_CIE_XYZ.times(components)
}
