Feature: Canvas
  ...
  Scenario: Creating a canvas
    ...
    And every pixel of canvas is linear_rgb_color(0, 0, 0)

  Scenario: Writing pixels to a canvas
    Given canvas ← canvas(10, 20)
    And red ← linear_rgb_color(1, 0, 0)
  ...
  Scenario: Constructing the PPM pixel data
    Given canvas ← canvas(5, 3)
    And color1 ← linear_rgb_color(1.5, 0, 0)
    And color2 ← linear_rgb_color(0, 0.5, 0)
    And color3 ← linear_rgb_color(-0.5, 0, 1)
  ...
  Scenario: Splitting long lines in PPM files
    ...
    When every pixel of canvas is set to linear_rgb_color(1, 0.8, 0.6)
    And ppm ← canvas_to_ppm(canvas)
  ...
  Scenario Outline: Reading pixel data from a PPM file
    ...
    Examples:
      | x | y | color                                    |
      | 0 | 0 | linear_rgb_color(1, 0.2122, 0)           |
      | 1 | 0 | linear_rgb_color(0, 0.2122, 1)           |
      | 2 | 0 | linear_rgb_color(0.2122, 1, 0)           |
      | 3 | 0 | linear_rgb_color(1, 1, 1)                |
      | 0 | 1 | linear_rgb_color(0, 0, 0)                |
      | 1 | 1 | linear_rgb_color(1, 0, 0)                |
      | 2 | 1 | linear_rgb_color(0, 1, 0)                |
      | 3 | 1 | linear_rgb_color(0, 0, 1)                |
      | 0 | 2 | linear_rgb_color(1, 1, 0)                |
      | 1 | 2 | linear_rgb_color(0, 1, 1)                |
      | 2 | 2 | linear_rgb_color(1, 0, 1)                |
      | 3 | 2 | linear_rgb_color(0.2122, 0.2122, 0.2122) |
  ...
  Scenario: PPM parsing ignores comment lines
    ...
    """
    When canvas ← canvas_from_ppm(ppm)
    Then pixel_at(canvas, 0, 0) = linear_rgb_color(1, 1, 1)
    And pixel_at(canvas, 1, 0) = linear_rgb_color(1, 0, 1)
  ...
  Scenario: PPM parsing allows an RGB triple to span lines
    ...
    """
    When canvas ← canvas_from_ppm(ppm)
    Then pixel_at(canvas, 0, 0) = linear_rgb_color(0.0331, 0.3185, 0.6038)
  ...
  Scenario: PPM parsing respects the scale setting
    ...
    """
    When canvas ← canvas_from_ppm(ppm)
    Then pixel_at(canvas, 0, 1) = linear_rgb_color(0.5225, 0.2140, 0.0508)
